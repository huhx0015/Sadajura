            ...
            if (readStatus != null) {
                ...
                else
                {
                    if (messageType.equals(ParseConstants.TYPE_IMAGE)) {
                        ...
                        String pushMessage = ParseUser.getCurrentUser().getUsername() + " just viewed your YourAppName photo!";
                    ...
                    {
                        String pushMessage = ParseUser.getCurrentUser().getUsername() + " just viewed your YourAppName video!";
