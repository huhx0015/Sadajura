package com.whomentors.sadajura.ui.dialog;
...
public class SJDialogBuilder extends AlertDialog.Builder {
    ...
    public SJDialogBuilder(Context context) {
        super(context);
     ...
     */
    public SJDialogBuilder setDividerColor(String colorString) {
    	mDivider.setBackgroundColor(Color.parseColor(colorString));
    	return this;
    }
 
    @Override
    public SJDialogBuilder setTitle(CharSequence text) {
        mTitle.setText(text);
        return this;
    }

    public SJDialogBuilder setTitleColor(String colorString) {
    	mTitle.setTextColor(Color.parseColor(colorString));
    	return this;
    }

    @Override
    public SJDialogBuilder setMessage(int textResId) {
        mMessage.setText(textResId);
        return this;
    }

    @Override
    public SJDialogBuilder setMessage(CharSequence text) {
        mMessage.setText(text);
        return this;
    }

    @Override
    public SJDialogBuilder setIcon(int drawableResId) {
        mIcon.setImageResource(drawableResId);
        return this;
    }

    @Override
    public SJDialogBuilder setIcon(Drawable icon) {
     ...
     * @param context
     */
    public SJDialogBuilder setCustomView(int resId, Context context) {
