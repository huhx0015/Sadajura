...
public class CJListAdapter extends RecyclerView.Adapter<CJListAdapter.CJResultViewHolder> {
    ...
    // LOGGING VARIABLES
    private static final String LOG_TAG = CJListAdapter.class.getSimpleName();

    /** INITIALIZATION METHODS _________________________________________________________________ **/

    // CJListAdapter(): Constructor method for CJListAdapter.
    public CJListAdapter(ArrayList<CJWishListModel> list, Boolean clickable, Activity act){
