...
/** -----------------------------------------------------------------------------------------------
 *  [CJMemory] CLASS
 *  DESCRIPTION: CJMemory class is a class that handles memory-related functionality, such as
 *  unbinding View groups that are no longer needed by activities.
 *  -----------------------------------------------------------------------------------------------
 */

public class CJUnbind {

    /** CLASS VARIABLES ________________________________________________________________________ **/

    // LOGGING VARIABLES
    public static final String LOG_TAG = CJUnbind.class.getSimpleName();
