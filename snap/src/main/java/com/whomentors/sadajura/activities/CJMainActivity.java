...
public class CJMainActivity extends FragmentActivity implements ActionBar.TabListener {
	
	public static final String TAG = CJMainActivity.class.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (currentUser == null) {
			...
			String appName = CJMainActivity.this.getString(R.string.app_name);
				...
				.setOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
					...
					public void onPageSelected(int position) {
						...
						if (position == 0)
						{
					        ...
					        LocalBroadcastManager.getInstance(CJMainActivity.this).sendBroadcast(newMessage);
						}
						else if (position == 1)
						{
							Intent newRequest = new Intent("updateRequests");
					        LocalBroadcastManager.getInstance(CJMainActivity.this).sendBroadcast(newRequest);
						}
						else if (position == 2)
						{
							Intent newFriend = new Intent("updateFriends");
					        LocalBroadcastManager.getInstance(CJMainActivity.this).sendBroadcast(newFriend);
						}
					}
				});
    ...
    */
	...
	private void navigateToLogin() {
		Intent intent = new Intent(this, CJLoginActivity.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch(itemId) {
			...
			case R.id.action_camera:
                ...
                final CJDialogBuilder CJDialogBuilder = new CJDialogBuilder(CJMainActivity.this);

                ListView cameraOptions = new ListView(CJMainActivity.this);
                cameraOptions.setBackgroundColor(Color.WHITE);
                cameraOptions.setSelector(R.drawable.list_item_selector);

                ArrayAdapter<String> modeAdapter = new ArrayAdapter<String>(CJMainActivity.this, android.R.layout.simple_list_item_1,
                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3)
                    {
                        ...
                        switch(position) {
                            case 0: // Take picture
                                ...
                                if (mMediaUri == null) {
                                    // display an error
                                    Toast.makeText(CJMainActivity.this, R.string.error_external_storage,
                            ...
                            case 3: // Choose video
                                ...
                                Toast.makeText(CJMainActivity.this, R.string.video_file_size_warning, Toast.LENGTH_LONG).show();
			...
			case R.id.action_logout:
                ...
                CJDialogBuilder CJDialogBuilder1 = new CJDialogBuilder(CJMainActivity.this);
                CJDialogBuilder1.setMessage(requestMessage)
                ...
                AlertDialog customDialog1 = CJDialogBuilder1.create();
                customDialog1.show();
